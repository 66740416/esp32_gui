...
void setup_scr_screen(lv_ui *ui)
{
	...
	lv_obj_set_style_bg_opa(ui->screen, 61, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_color(ui->screen, lv_color_hex(0x7500ff), LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_pos(ui->screen_btn_1, 110, 95);
